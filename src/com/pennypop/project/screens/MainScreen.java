...
public class MainScreen implements Screen {
	...
	public MainScreen() {
        ...
        pennyLabel.setPosition(Gdx.graphics.getWidth()/4 - pennyLabel.getWidth()/2 , (float) (Gdx.graphics.getHeight() * 0.6));
	 ...
	 * Pulls weather data from OpenWeatherMap, then displays labels for weather on MainScreen
	 */
	...
	/**
	 * Defines the styles for various UI Widgets and stores them in the Skin variable
	 */
